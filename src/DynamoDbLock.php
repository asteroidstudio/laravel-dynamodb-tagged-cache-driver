...
class DynamoDbLock extends Lock
{
     ...
     *
     * @var \Illuminate\Cache\TaggedDynamodbStore
     */
    protected $dynamo;
     ...
     *
     * @param  \Illuminate\Cache\TaggedDynamodbStore  $dynamo
     * @param  string  $name
     * @param  int  $seconds
     * @param  string|null  $owner
     * @return void
     */
    public function __construct(TaggedDynamodbStore $dynamo, $name, $seconds, $owner = null)
    {
